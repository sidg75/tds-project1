...
This project involved scraping GitHub user's and their repositories data via API. Data was organised into two separate CSV files, and used for data analysis via Google Sheets
